...
/**
 * Class LoadJsonClientCommand
 * @package App\UI\Cli
 */
class LoadJsonClientCommand extends Command
{

    use CommandTrait;

    /**
     * Le nome de la commande: bin/console app:load-json
     * @var string
     */
    protected static $defaultName = 'app:load-json';

    /**
     * le nom de fichier
     * @var string
     */
    protected $fileName = 'client.json';
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        // lire le fichier
        $data = $this->readJsonFile($input, $output);

        // créer le client
        $client = $this->createClient($data, $data[Client::COL_DECISION]);
